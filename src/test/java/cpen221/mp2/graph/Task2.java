...
class Task2 {
    ...
    private static Stream<Arguments> searchProvider() {
        return Stream.of(
                Arguments.of(g0, lv0.get(0), 9, Set.of(lv0.get(1), lv0.get(3))),
                Arguments.of(g0, lv0.get(0), 15, Set.of(lv0.get(1), lv0.get(2), lv0.get(3))),
                Arguments.of(g3, lv1.get("I"), 42, Set.of(
                        lv1.get("J"), lv1.get("F"), lv1.get("W"), lv1.get("H"))
                )
        );
    }
    ...
    void search(Graph<Vertex, Edge<Vertex>> g, Vertex v, int distance, Set<Vertex> expected) {
        assertEquals(expected, g.search(v, distance));
    }
